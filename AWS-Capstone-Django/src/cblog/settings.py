...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name='/sahin/capstone/username')
    password_param = ssm.get_parameter(Name="/sahin/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstonesahin.cco1wibt0442.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'sahincapstonestatic' # please enter your s3 bucket name
